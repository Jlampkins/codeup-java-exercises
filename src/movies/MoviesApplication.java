...
//    private static Input scanner = new Input();
    ...
    private static void searchMovie() {
        System.out.println("Welcome to Movie Fone!");
    ...
    private static void newSearch(){
        ...
        if(newSearchResponse.startsWith("y") || newSearchResponse.startsWith("Y")){
            searchMovie();
        }
    }
    ...
    /** this one **/
//    static Movie[] addMovie(Movie[] Movie, Movie movieName, Movie movieCategory){
//        Movie[] updatedMovieList;
//        updatedMovieList = Arrays.copyOf(Movie, Movie.length + 1);
//        updatedMovieList[updatedMovieList.length - 1] = movieName;
//        updatedMovieList[updatedMovieList.length - 1] = movieCategory;
